(function ($) {
  ...
  /*---------- 01. On Load Function ----------*/
    ...
    if (modal) {
        ...
        // Optional: If you want to handle the escape key
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Start slideshow and handle hover pause
        startSlideShow();
    ...
    function handleSubmit(event) {
        ...
        const scriptURL = 'https://script.google.com/macros/s/AKfycbwURS93xaKx7kiNqbvgAd16gm3GzSoiCc99wfjIxJp5x3_WMvHtWa7wVBZd2n9OSYEhmg/exec';
    ...
    function showMessage(message, type) {
        const messageDiv = document.querySelector('.form-messages');
        messageDiv.textContent = message;
        messageDiv.className = 'form-messages mb-0 mt-3 ' + type;
    ...
    function validateForm() {
        const requiredFields = ['name', 'email', 'number', 'subject', 'date-pick', 'time-pick'];
        let isValid = true;
    ...
    function startCounters() {
        ...
        counters.forEach(counter => {
            ...
            const updateCount = () => {
                const increment = target / (1000 / speed); // Adjust for smoother animation
    ...
    // Start counter animation when modal is shown
    document.getElementById('adherenceModal').addEventListener('shown.bs.modal', function () {
        startCounters();
    });

    // Reset counters when modal is hidden
    document.getElementById('adherenceModal').addEventListener('hidden.bs.modal', function () {
        const counters = document.querySelectorAll('.counter');
        counters.forEach(counter => {
            counter.innerText = '0';
        });
